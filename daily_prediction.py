...
def export_results(result_df, base_gpkg_path, output_geojson_path, output_html_path, target_date, best_days):
    ...
    if 'Susceptibility_Prob' in export_gdf.columns:
...
if __name__ == "__main__":
    try:
        ...
        # Rimuoviamo il file GeoJSON datato generato inizialmente per risparmiare spazio, 
        # mantenendo solo latest_map.geojson che viene pushato
        os.remove(out_json)
